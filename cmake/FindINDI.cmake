...
if(${INDI_PUBLIC_VAR_NS}_INCLUDE_DIR)
    ...
    if(${INDI_PRIVATE_VAR_NS}_VERSION_HEADER_CONTENTS MATCHES ".*INDI_VERSION ([0-9]+).([0-9]+).([0-9]+)")
            ...
            add_definitions(-D${INDI_PUBLIC_VAR_NS}_MAJOR_VERSION=${CMAKE_MATCH_1})
            message("INDI_MAJOR_VERSION: ${INDI_PUBLIC_VAR_NS}_MAJOR_VERSION=${CMAKE_MATCH_1}")
            set(${INDI_PUBLIC_VAR_NS}_MINOR_VERSION "${CMAKE_MATCH_2}")
            add_definitions(-D${INDI_PUBLIC_VAR_NS}_MINOR_VERSION=${CMAKE_MATCH_2})
            message("INDI_MINOR_VERSION: ${INDI_PUBLIC_VAR_NS}_MINOR_VERSION=${CMAKE_MATCH_2}")
            set(${INDI_PUBLIC_VAR_NS}_RELEASE_VERSION "${CMAKE_MATCsH_3}")
            add_definitions(-D${INDI_PUBLIC_VAR_NS}_RELEASE_VERSION=${CMAKE_MATCH_3})
            message("INDI_RELEASE_VERSION: ${INDI_PUBLIC_VAR_NS}_RELEASE_VERSION=${CMAKE_MATCH_3}")
    else()

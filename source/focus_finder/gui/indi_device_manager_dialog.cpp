...
void IndiDeviceManagerDialogT::onHostnameChanged(const QString & hostname) {
    LOG(debug) << "IndiDeviceManagerDialogT::onHostnameChanged()...new hostname=" << hostname.toStdString() << std::endl;
...
void IndiDeviceManagerDialogT::onConnectIndiServerClicked() {
  ...
  if (IndiServerConnectionStateT::CONNECTED == mIndiServerConnectionState) {
    ...
    LOG(warning) << "Unknown connection state: " << IndiServerConnectionStateT::asStr(mIndiServerConnectionState) << std::endl;      
  }
}

void IndiDeviceManagerDialogT::onServerConnectionStateChanged(IndiServerConnectionStateT::TypeE indiServerConnectionState) {
  
  LOG(debug) << "IndiDeviceManagerDialogT::onServerConnectionStateChanged(indiServerConnectionState=" << IndiServerConnectionStateT::asStr(indiServerConnectionState) << ")..." << std::endl;
...
void IndiDeviceManagerDialogT::setButtonConnectionState(
  ...
  LOG(debug) << "setButtonConnectionState(state=" << IndiServerConnectionStateT::asStr(btnConnState) << ")..." << std::endl;
...
void IndiDeviceManagerDialogT::createConnectIndiServerButton() {
	...
	setButtonConnectionState(isIndiServerConnected ? IndiServerConnectionStateT::CONNECTED : IndiServerConnectionStateT::DISCONNECTED);
...
IndiDeviceManagerDialogT::IndiDeviceManagerDialogT(QWidget * parent, std::shared_ptr<IndiDeviceManagerT> indiDeviceManager) : QDialog(parent),
															      m_ui(new Ui::IndiDeviceManagerDialog),
			      mIndiDeviceManager(indiDeviceManager)
{

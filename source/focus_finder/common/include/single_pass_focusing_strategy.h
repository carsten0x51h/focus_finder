...
#ifndef SOURCE_FOCUS_FINDER_COMMON_INCLUDE_FOCUS_FINDER_SINGLE_PASS_FOCUSING_STRATEGY_H_
#define SOURCE_FOCUS_FINDER_COMMON_INCLUDE_FOCUS_FINDER_SINGLE_PASS_FOCUSING_STRATEGY_H_ SOURCE_FOCUS_FINDER_COMMON_INCLUDE_FOCUS_FINDER_SINGLE_PASS_FOCUSING_STRATEGY_H_
...
class SinglePassFocusingStrategyT : public FocusFinderT {
private:
    // Prevent copy
    SinglePassFocusingStrategyT(const SinglePassFocusingStrategyT &);

    SinglePassFocusingStrategyT &operator=(const SinglePassFocusingStrategyT &);
...
public:
    explicit SinglePassFocusingStrategyT(std::shared_ptr<FocusControllerT> focusController);
...
#endif /* SOURCE_FOCUS_FINDER_COMMON_INCLUDE_FOCUS_FINDER_SINGLE_PASS_FOCUSING_STRATEGY_H_ */

...
#define SOURCE_FOCUS_FINDER_COMMON_INCLUDE_FOCUS_FINDER_CALIBRATION_H_ SOURCE_FOCUS_FINDER_COMMON_INCLUDE_FOCUS_FINDER_CALIBRATION_H_
...
public:
    ...
    void setCalibrationData(const FocusCurveRecordSetContainerT &focusCurveRecordSetContainer,
    ...
    load(const boost::property_tree::ptree &pt, const CurveFitParmsT &curveFitParms,
         const std::filesystem::path &lightFramePath);

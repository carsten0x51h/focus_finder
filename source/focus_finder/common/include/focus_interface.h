...
public:
    ...
    */
    ...
    registerFocusPositionChangedListener(const FocusPositionChangedListenersT::slot_type &inCallBack) {
        return mFocusPositionChangedListeners.connect(inCallBack);
    }

    template<class T>
    void unregisterFocusPositionChangedListener(const T &inCallBack) {
    ...
    */
    ...
    boost::signals2::connection
    registerFocusMovementAbortedListener(const FocusMovementAbortedListenersT::slot_type &inCallBack) {
        return mFocusMovementAbortedListeners.connect(inCallBack);
    }

    template<class T>
    void unregisterFocusMovementAbortedListener(const T &inCallBack) {

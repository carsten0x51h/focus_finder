...
#define SOURCE_FOCUS_FINDER_COMMON_INCLUDE_BOUNDARY_LOCATION_H_ SOURCE_FOCUS_FINDER_COMMON_INCLUDE_BOUNDARY_LOCATION_H_
...
struct BoundaryLocationT {
    ...
    static const char *asStr(const TypeE &inType) {
        switch (inType) {
            ...
            case WITHIN_BOUNDARY_RANGE:
                return "WITHIN_BOUNDARY_RANGE";
            default:
                return "<?>";
        }
    }
